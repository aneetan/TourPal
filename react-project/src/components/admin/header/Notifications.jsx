                ...
                return (
                    <div className="w-full ps-3">
                        <div className="text-gray-500 text-[13px] mb-1.5 dark:text-gray-400">
                            {notification.text} <span className="font-semibold text-gray-900 dark:text-white">{notification.user}</span> {notification.content}
                        </div>
                    ...
                    notifications.map(notification => (
                        <a key={notification.id} href="#" className="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
                            <div className="shrink-0">
                                <Avatar className="rounded-full w-11 h-11" src={notification.img}/>
                            </div>
